...
console.log('\nHostinger hPanel:');
console.log('  1. Dağıtımlar → Yeni dağıtım → "Yeni dosyaları yükleyin"');
console.log('  2. portal.zip yükle');
console.log('  3. Framework: Next.js (veya Other)');
console.log('  4. Entry file: server.js');
console.log('  5. Build: npm run build');
console.log('  6. Start: npm start');
console.log('  7. Node.js: 20.x');
